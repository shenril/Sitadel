...
from sitadel.modules.attacks.authz.access_control import AccessControl
from sitadel.modules.attacks.authz.idor import Idor
from sitadel.modules.attacks.authz.idutils import object_refs, replace_id, different
